...
mock_pipeline.py
----------------
Returns realistic fake audit results for local UI/UX development.
No API keys required. Exercises all parts of the frontend:
  - High/medium/low risk flags
  - Multiple clause types
  - Risk score gauge
  - PDF report generation

Enable by setting MOCK_MODE=true in .env (default in local dev).
"""
...
def run_mock_audit(
    ...
    """
    Returns a realistic fake audit result for UI/UX testing.
    Simulates processing time with staged progress updates.
    """
    ...
    return AuditResult(
        tenant_name=tenant_name or "Demo Tenant Pty Ltd",
